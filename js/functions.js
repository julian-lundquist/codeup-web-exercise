...
function calculateTip(tipPercent, totalAmount) {
    var tipCalc = tipPercent * totalAmount;
    return tipCalc;
}
...
function applyDiscount(originalPrice, discountPercent) {
    ...
    alert('Total price with applied discount is $' + discountCalc);
    return discountCalc;
}

var originalPrice = prompt('What is the original price of the item?');
var discountPercent = prompt('What is the discount % applied? (via decimal)');

applyDiscount(parseFloat(originalPrice), parseFloat(discountPercent));